    ...
    public abstract unsafe class VideoViewBase : Control, IVideoView
    {
        ...
        bool UpdateOuput(IntPtr opaque, RenderConfig* config, ref OutputConfig output)
        {
            ...
            fixed (void* handle = &_sharedHandle)
                ThrowIfFailed(sharedResource->CreateSharedHandle(null, DXGI.DXGI_SHARED_RESOURCE_READ | DXGI.DXGI_SHARED_RESOURCE_WRITE, null, (HANDLE*)handle));
